...
import { a as getBaseURL, i as PACKAGE_VERSION, o as useI18n, r as GENERIC_OAUTH_ERROR_CODES } from "./router-BlH2ykBS.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/button-BlBRFBql.js
...
function LanguageSwitch({ tone = "paper" }) {
	const { lang, setLang, t } = useI18n();
	const isNight = tone === "night";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		role: "group",
		"aria-label": t.langAria,
		className: cn("flex h-11 shrink-0 items-center rounded-full p-1", isNight ? "bg-ivory/8" : "bg-ink/6"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
			onClick: () => setLang("en"),
			"aria-pressed": lang === "en",
			className: cn("h-9 min-w-11 rounded-full px-3 text-xs font-medium tracking-wide transition-colors duration-150", lang === "en" ? isNight ? "bg-ivory text-ink" : "bg-ink text-ivory" : isNight ? "text-ivory/70 hover:text-ivory" : "text-muted hover:text-ink"),
			children: t.langEn
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
			onClick: () => setLang("zh"),
			"aria-pressed": lang === "zh",
			className: cn("h-9 min-w-11 rounded-full px-3 text-xs font-medium tracking-wide transition-colors duration-150", lang === "zh" ? isNight ? "bg-ivory text-ink" : "bg-ink text-ivory" : isNight ? "text-ivory/70 hover:text-ivory" : "text-muted hover:text-ink"),
			children: t.langZh
		})]
	});
}
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 rounded-full font-medium transition-[opacity,transform,background-color,color] duration-150 ease-out active:not-disabled:scale-[0.96] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-merlot disabled:opacity-50", {
	variants: {
		variant: {
			primary: "bg-merlot text-ivory hover:bg-merlot-hover",
			ivory: "bg-ivory text-ink hover:opacity-90",
			ghost: "bg-transparent text-ink hover:bg-ink/6 border border-line",
			night: "bg-transparent text-ivory hover:bg-ivory/10 border border-line-night"
		},
		size: {
...
function Button({ className, variant, size, asChild, ref, ...props }) {
...
//#endregion
export { signOut as a, signIn as i, LanguageSwitch as n, authClient as r, Button as t };
